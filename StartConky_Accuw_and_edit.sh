...
1.9)
#
ans=$(zenity  --title="Accuweather  Conky v1.9 and Gedit" --list  --width=400 --height=700 --text "Select task from the list below." --checklist  --column "Run" --column "Task" FALSE ".conkyrc_acc_hourly_2015" FALSE ".conkyrc_acc_hourly_2016" FALSE ".conkyrc_acc_hourly_weatherfont" FALSE ".conkyrc_acc_images_2015" FALSE ".conkyrc_acc_images_2016" FALSE ".conkyrc_acc_images_wind_2015" FALSE ".conkyrc_acc_images_wind_2016" FALSE ".conkyrc_acc_weatherfont" FALSE ".conkyrc_acc_weatherfont_simple" FALSE ".conkyrc_acc_weatherfont_simpler" FALSE ".conkyrc_acc_weatherfont_wind" FALSE ".conkyrc_acc_images" FALSE ".conkyrc_acc_font" FALSE "*******************************" FALSE "conkyllia-run-wx5_sh" FALSE "Conky-NoobsLab" FALSE "Conkylla1" FALSE "Conkylla2" FALSE "Conkylla" --separator=":")
...
sleep 2
	killall StartConky_Accuw_and_edit.sh
	fi
...
#
#
ans=$(zenity  --title="Accuweather  Conky v1.10 and Gedit"\
